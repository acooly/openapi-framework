...
public class ApiServiceManagerController extends AbstractJQueryEntityController<ApiService, ApiServiceService> {
    ...
    @Autowired
    private ApiServiceTypeService aiServiceTypeService;
    ...
    @Override
    protected void onEdit(HttpServletRequest request, HttpServletResponse response, Model model, ApiService entity) {
    ...
    @Override
    protected void onShow(HttpServletRequest request, HttpServletResponse response, Model model, ApiService entity)
            throws Exception {
        super.onShow(request, response, model, entity);
    }

    @Override
    protected ApiService onSave(HttpServletRequest request, HttpServletResponse response, Model model, ApiService entity,
