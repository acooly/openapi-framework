...
import com.acooly.openapi.framework.serviceimpl.persistent.dao.NotifyMessageDao;
...
public class NotifyMessageDaoImpl extends AbstractJdbcTemplateDao implements NotifyMessageDao {
  ...
  private String getSelectSql() {
    return "select id,gid,partner_id as partnerId,message_type as messageType,service,version,url,content,send_count as sendCount,"
        ...
        + "resp_info as respInfo,request_no as requestNo, merch_order_no as merchOrderNo from "
        + TABLE_NAME;
  }
  ...
  public void insert(final NotifyMessage notifyMessage) {
    final String sql =
        "insert into "
            ...
            + "gid,partner_id,message_type,service,version,url,content,send_count,next_send_time,status,execute_status,create_time,update_time,resp_info,request_no,merch_order_no) "
            + " values("
