...
public class ApiServiceTypeManagerController
    extends AbstractJQueryEntityController<ApiServiceType, ApiServiceTypeService> {
  ...
  protected ApiServiceType doSave(
    ...
    if (isCreate) {
      entity =
          getEntityService().create(entity.getParentId(), entity.getName(), entity.getComments());
    } else {
  ...
  @ResponseBody
  public JsonListResult<ApiServiceType> loadTree(
