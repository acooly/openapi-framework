...
<div>
    <form id="manage_qaClassify_editform" action="${pageContext.request.contextPath}/manage/qa/qaClassify/${action=='create'?'saveJson':'updateJson'}.html" method="post">
      <jodd:form bean="qaClassify" scope="request">
