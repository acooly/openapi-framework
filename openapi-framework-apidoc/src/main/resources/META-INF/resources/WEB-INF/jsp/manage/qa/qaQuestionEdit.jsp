...
<div>
	<form id="manage_qaQuestion_editform" action="${pageContext.request.contextPath}/manage/qa/qaQuestion/${action=='create'?'saveJson':'updateJson'}.html" method="post">
		<jodd:form bean="qaQuestion" scope="request">
			<input name="id" type="hidden" />
			<table class="tableForm" width="100%" align="center">
				<tr>
					<th style="width: 80px">分类：</th>
					<td>${typeName}<input type="hidden" name="qaClassify.id" value="${typeId}" />
				</tr>
				<tr>
