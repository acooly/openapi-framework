/** acooly.com Inc. Copyright (c) 2011 All Rights Reserved. */
package com.acooly.openapi.framework.common.utils;

import java.io.IOException;

/**
 * @Filename Hex.java @Description @Version 1.0 @Author bohr.qiu @Email qiubo@qq.com @History
 * <li>Author: bohr.qiu
 * <li>Date: 2013-9-3
 * <li>Version: 1.0
 * <li>Content: create
...
public final class Hex {
  ...
  /**
   * Parses a <code>long</code> from a hex encoded number. This method will skip all characters that
   * are not 0-9, A-F and a-f.
   *
   * <p>Returns 0 if the {@link CharSequence} does not contain any interesting characters.
   *
   * @param s the {@link CharSequence} to extract a <code>long</code> from, may not be <code>null
   *     </code>
   ...
   * <p>Returns 0 if the {@link CharSequence} does not contain any interesting characters.
   *
   * @param s the {@link CharSequence} to extract a <code>short</code> from, may not be <code>null
   *     </code>
