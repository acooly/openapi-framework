 ...
 * 抽象orderInfoDao
 *
 * <p>使用ketama-hash动态定位当前访问操作的表名称
 *
 * <p>Created by zhangpu on 2015/9/4.
 */
public abstract class AbstractDistributedDao {
  ...
  protected static KetamaNodeLocator ketamaNodeLocator =
      new KetamaNodeLocator("", NODES, NODE_COPIES, "_");
