...
public class OpenApiThreadPoolTaskExecutorFactory {
  private static volatile OpenApiThreadPoolTaskExecutor threadPoolTaskExecutor = null;
  ...
  private static void init() {
    ...
    threadPoolTaskExecutor.setRejectedExecutionHandler(new OpenApiRejectedExecutionHandler());
