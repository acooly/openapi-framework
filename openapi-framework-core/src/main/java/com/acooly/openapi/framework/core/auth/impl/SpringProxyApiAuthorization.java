 ...
 * 认证授权 spring代理实现.
 * <p/>
 * 自动判断优先使用目标集成系统的认证实现,如果没有,则使用默认实现(DafaultApiAuthorizer)
 *
 * @author acooly
 * @date 2016-02-29
 */
@Service("apiAuthorization")
public class SpringProxyApiAuthorization extends AbstractSpringProxyBean<ApiAuthorization, DefaultApiAuthorization> implements ApiAuthorization {
