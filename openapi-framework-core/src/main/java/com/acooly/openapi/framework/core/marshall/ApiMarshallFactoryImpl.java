...
public class ApiMarshallFactoryImpl implements ApiMarshallFactory, InitializingBean {
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    Map<String, ApiRequestMarshall> apiRequestMarshalls =
        applicationContext.getBeansOfType(ApiRequestMarshall.class);
    ...
    Map<String, ApiResponseMarshall> apiResponseMarshalls =
        applicationContext.getBeansOfType(ApiResponseMarshall.class);
    ...
    Map<String, ApiRedirectMarshall> apiRedirectMarshalls =
        applicationContext.getBeansOfType(ApiRedirectMarshall.class);
    ...
    Map<String, ApiNotifyMarshall> apiNotifyMarshalls =
        applicationContext.getBeansOfType(ApiNotifyMarshall.class);
