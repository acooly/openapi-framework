...
/*
 * 修订记录:
 * qzhanbo@yiji.com 2014-07-25 02:04 创建
 *
 */
...
public class ApiServiceParamFormatException extends ApiServiceException {
	 ...
	 * @param paramValue
	 *            参数值
	 * @param requiredTypeOrFormat
	 *            期望的类型.
	 */
	public ApiServiceParamFormatException(String paramName, Object paramValue, String requiredTypeOrFormat) {
		super(ApiServiceResultCode.PARAM_FORMAT_ERROR.getCode(), ApiServiceResultCode.PARAM_FORMAT_ERROR.getMessage(),
