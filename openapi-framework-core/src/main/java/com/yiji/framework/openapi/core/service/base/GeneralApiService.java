...
import com.yiji.framework.openapi.core.listener.ApiListener;
import com.yiji.framework.openapi.core.listener.OpenApiEventMulticaster;
import com.yiji.framework.openapi.core.listener.event.ServiceEvent;
import com.yiji.framework.openapi.core.listener.multicaster.ServiceEventMulticaster;
import com.yiji.framework.openapi.core.util.GenericsUtils;
...
public abstract class GeneralApiService<O extends ApiRequest, R extends ApiResponse>
    ...
    public O getRequestBean() {
        ...
        try {
            ...
            throw new RuntimeException("实例化Request对象失败:"
                    + requestClazz.toString());
        }
    }
    ...
    public R getResponseBean() {
        ...
        try {
            ...
            throw new RuntimeException("实例化Response对象失败:"
                    + responseClazz.toString());
        }
    }
