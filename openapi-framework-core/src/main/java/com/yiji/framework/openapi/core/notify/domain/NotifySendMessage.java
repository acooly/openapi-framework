 ...
 *
 */
package com.yiji.framework.openapi.core.notify.domain;
 ...
 * @author zhangpu
 */
public class NotifySendMessage extends LinkedHashMapParameterize<String, String> implements Serializable {
